...
# Load the dataset
import_export = pd.read_csv(r"C:\\Users\\KASHISH\\Downloads\\Kashish Dashboard\\Imports_Exports_Dataset_csv.csv")

# Sample 3001 rows from the dataset
my_data = import_export.sample(n=3001, replace=False, random_state=55046)
...
fig1.update_layout(height=400, title_x=0.2)  # Center-align title
...
fig2.update_layout(height=400, title_x=0.2)  # Center-align title
...
fig3.update_layout(height=400, title_x=0.2)  # Center-align title
...
fig4.update_layout(xaxis_tickangle=-45, height=400, title_x=0.2)  # Center-align title
...
fig5.update_layout(height=400, title_x=0.2)  # Center-align title
...
fig6.update_layout(height=400, title_x=0.2)  # Center-align title
...
fig7.update_layout(width=1200, height=700, title_x=0.2)  # Center-align title
